...
def run_linear(
    ...
    """
    from student.modules import Linear
...
def run_embedding(
    ...
    from student.modules import Embedding
...
def run_swiglu(
    ...
    from student.modules import SwiGLUFeedForward

    swiglu = SwiGLUFeedForward(d_model=d_model, d_ff=d_ff, device=w1_weight.device, dtype=w1_weight.dtype)
...
def run_scaled_dot_product_attention(
    ...
    """
    from student.modules import scaled_dot_product_attention
...
def run_multihead_self_attention(
    ...
    """
    from student.modules import MultiHeadSelfAttention

    mha = MultiHeadSelfAttention(
        d_model=d_model, num_heads=num_heads, use_rope=False, device=q_proj_weight.device, dtype=q_proj_weight.dtype
    )
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    from student.modules.multihead_attention import MultiHeadSelfAttention
...
def run_rope(
    ...
    """
    from student.modules import RotaryPositionalEmbedding

    rope = RotaryPositionalEmbedding(d_k=d_k, theta=theta, max_seq_len=max_seq_len, device=in_query_or_key.device)
...
def run_transformer_block(
    ...
    """
    from student.modules import TransformerBlock
    ...
    block = TransformerBlock(
        ...
        max_seq_len=max_seq_len,
        theta=theta,
        use_rope=True,  # Tests always use RoPE
...
def run_rmsnorm(
    ...
    """
    from student.modules import RMSNorm
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    from student.modules import silu
...
def run_get_batch(
    ...
    """
    from student.dataloader import get_batch
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    from student.modules import softmax
...
def run_cross_entropy(
    ...
    """
    from student.modules import cross_entropy
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from student.gradient import clip_grad_norm
...
def run_get_lr_cosine_schedule(
    ...
    """
    from student.lr_schedule import get_lr_cosine_scheduler
...
def run_save_checkpoint(
    ...
    """
    from student.checkpoint import save_checkpoint
...
def run_load_checkpoint(
    ...
    """
    from student.checkpoint import load_checkpoint
